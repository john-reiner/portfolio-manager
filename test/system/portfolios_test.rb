...
class PortfoliosTest < ApplicationSystemTestCase
  ...
  test "should create portfolio" do
    ...
    fill_in "About me text", with: @portfolio.about_me_text
    fill_in "Email", with: @portfolio.email
    fill_in "Password digest", with: @portfolio.password_digest
    fill_in "Welcome message", with: @portfolio.welcome_message
