...
class SkillCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill_category" do
    assert_difference("SkillCategory.count") do
      post skill_categories_url, params: { skill_category: { name: @skill_category.name, portfolio_id: @skill_category.portfolio_id } }
    end
  ...
  test "should update skill_category" do
    patch skill_category_url(@skill_category), params: { skill_category: { name: @skill_category.name, portfolio_id: @skill_category.portfolio_id } }
